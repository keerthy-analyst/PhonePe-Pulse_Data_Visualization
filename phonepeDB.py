...
phn = Image.open('C:/Users/Public/pythonProject1/png/PhonePe-logo-icon.png')
phn1 = Image.open('C:/Users/Public/pythonProject1/png/PhonePe-Logo.wine.png')
my_pic = Image.open('C:/Users/Public/pythonProject1/png/100257.png')
video_file = open('C:/Users/Public/pythonProject1/video pulse1.mp4', 'rb')
video1 = video_file.read()
video_file = open('C:/Users/Public/pythonProject1/video pulse 2.mp4', 'rb')
...
# <-----------------------------------------------------------------------creating options using STREAMLIT--------------------------------------------------------------------->
# with st.sidebar:
SELECT = option_menu(
    menu_title=None,
